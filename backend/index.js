...
app.use((req, res, next) => {
  ...
  if (origin && (allowedOrigins.includes(origin) || /^http:\/\/(localhost|127\.0\.0\.1)/.test(origin))) {
...
app.get('/api', (req, res) => {
  ...
  'POST /api/detect-ats-issues',
  'POST /api/tailor-resume',
  'POST /api/polish-text',
  'POST /api/translate-text',
  'POST /api/suggest-section-order',
  'POST /api/keyword-gap',
  'POST /api/readability',
  'POST /api/weave-keywords'
      ],
      admin: [
